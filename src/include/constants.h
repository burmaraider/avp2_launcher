...
static const char *const AVP2_TOOLTIPS[8] = {
    "What the hell am I looking at here?!", "This is for advanced users only. The command line is used for setting console variables at startup.", "This will disable all sound effects. Use this for troublehooting only.", "This will disable the use of DirectMusic. Some sound cards may have incompatibilities with DirectMusic.  Use this for troubleshooting only.", "This will disable the logo movies at the start of the game.", "This will disable a feature on some video cards that can improve performance, but uses more of the card's video memory as a result.  Most AGP video cards benefit from this feature being enabled.  However, this may cause lock-ups on a few PCI video cards.", "This will disable all joysticks and gamepads.  Use this if your particular joystick is causing problems when the game starts.", "This will disable the use of a hardware cursor. Some older cards do not support the hardware cursor."};
