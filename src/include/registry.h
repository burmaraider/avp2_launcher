...
static int GetRegistryInt(HKEY hk, const char *key, const char *value, int defaultValue)
{
    HKEY hKey;
...
static char *GetRegistryString(HKEY hK, const char *StringName, char *valueBuffer, DWORD *value_length)
{
...
static bool GetRegistryEntries()
{
...
static bool InstallAVP2Registry()
{
...
static void SetRegistryValue(HKEY hKey, const char* pszValueName, DWORD dwType, const void* pData, DWORD dwDataSize)
{
    HKEY hSubKey = 0;
    DWORD dwDisposition = 0;
